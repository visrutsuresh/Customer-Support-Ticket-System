...
Reads the committed 400-row corpus at data/kb_seed.jsonl. Nothing is downloaded,
so this needs no network and no `datasets` dependency.
...
def load_rows() -> list[dict]:
    # the 400-row corpus is committed at SEED_FILE, so nothing is ever downloaded.
    # The original Bitext pull that produced it lives in git history.
