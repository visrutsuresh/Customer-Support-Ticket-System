...
resolved_tickets = [
    {
        "title": "Password reset link kept expiring",
        "content": "Customer's reset link expired before use. We sent a fresh 30-minute link and asked them to clear cache first. Resolved on first reply, no escalation.",
    },
    {
        "title": "Charged twice for one order",
        "content": "Customer saw a duplicate charge. We confirmed only one order shipped and refunded the duplicate to the original card. Refund landed in 6 business days.",
    },
    {
        "title": "Wanted refund on unused annual subscription",
        "content": "Customer requested a refund on an unused annual plan within 30 days. Approved per policy, prorated the unused time, refunded to original payment method.",
    },
    {
        "title": "Could not change account email",
        "content": "Customer lost access to their old email and could not receive the confirmation link. We verified identity manually and updated the account email for them.",
    },
]
